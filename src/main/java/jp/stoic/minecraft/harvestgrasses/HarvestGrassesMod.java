...
public class HarvestGrassesMod {
    ...
    private final static List<String> noDropBlockNames = Arrays.asList(
            "air", "flowing_water", "water", "flowing_lava", "lava", "fire", "barrier", "WhiteShulkerBox", "OrangeShulkerBox", "MagentaShulkerBox", "LightBlueShulkerBox", "YellowShulkerBox", "LimeShulkerBox", "PinkShulkerBox", "GreyShulkerBox", "LightGreyShulkerBox", "CyanShulkerBox", "PurpleShulkerBox", "BlueShulkerBox", "BrownShulkerBox", "GreenShulkerBox", "RedShulkerBox", "BlackShulkerBox"
    );
